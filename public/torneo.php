...
<section>
  ...
  <div class="fila"><a class="btn" href="#">Seguir torneo</a><a class="btn btn-primario" href="#">Inscribir equipo</a></div>
</section>
<div class="vista" id="calendario">
  <div class="pestanas"><a href="#resumen">Resumen</a><a href="#calendario" class="activo">Calendario</a><a href="#posiciones">Posiciones</a><a href="#participantes">Participantes</a><a href="#reglas">Reglas</a></div>
...
<div class="vista" id="posiciones">
  <div class="pestanas"><a href="#resumen">Resumen</a><a href="#calendario">Calendario</a><a href="#posiciones" class="activo">Posiciones</a><a href="#participantes">Participantes</a><a href="#reglas">Reglas</a></div>
  <section class="tarjeta">
...
<div class="vista" id="participantes">
  <div class="pestanas"><a href="#resumen">Resumen</a><a href="#calendario">Calendario</a><a href="#posiciones">Posiciones</a><a href="#participantes" class="activo">Participantes</a><a href="#reglas">Reglas</a></div>
  <section class="tarjeta">
  <h2>Participantes</h2>
  <div class="tabla-scroll">
  <table>
...
<div class="vista" id="reglas">
  <div class="pestanas"><a href="#resumen">Resumen</a><a href="#calendario">Calendario</a><a href="#posiciones">Posiciones</a><a href="#participantes">Participantes</a><a href="#reglas" class="activo">Reglas</a></div>
  <section class="tarjeta">
  <h2>Reglas</h2>
  <table>
    <tbody>
      <tr><td class="etiqueta">Formato</td><td>Liga de doce equipos, todos contra todos, una vuelta.</td></tr>
      <tr><td class="etiqueta">Puntaje</td><td>Tres puntos la victoria, uno el empate, ninguno la derrota.</td></tr>
      <tr><td class="etiqueta">Desempate</td><td>Primero la diferencia entre mapas ganados y perdidos; si persiste, los mapas ganados.</td></tr>
      <tr><td class="etiqueta">Ausencia</td><td>Un equipo que no se presenta a la hora pactada pierde el enfrentamiento por walkover, sin necesidad de jugarlo.</td></tr>
    </tbody>
  </table>
...
<div class="vista" id="resumen">
  <div class="pestanas"><a href="#resumen" class="activo">Resumen</a><a href="#calendario">Calendario</a><a href="#posiciones">Posiciones</a><a href="#participantes">Participantes</a><a href="#reglas">Reglas</a></div>
  <section class="tarjeta">
  <h2>Resumen</h2>
